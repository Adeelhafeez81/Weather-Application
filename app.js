...
<span class="m-icon"><i class="fa-solid fa-calendar-week"></i></span>
...
<span class="m-icon"><i class="fa-solid fa-location-crosshairs"></i></span>
...
<div class="card-list">
  ...
  <div class="card-item">
    <span class="m-icon"><i class="fa-solid fa-sun"></i>i> </span>
  ...
  <div class="card-item">
    <span class="m-icon"><i class="fa-solid fa-moon"></i></span>
...
<div class="wrapper">
  ...
  <span class="m-icon"><i class="fa-solid fa-cloud"></i></span>
...
<div class="card card-sm highlight-card">
  ...
  <div class="card card-sm highlight-card">
    ...
    <div class="wrapper">
      ...
      <span class="m-icon"><i class="fa-solid fa-eye-slash"></i></span>
    ...
    <div class="card card-sm highlight-card">
      ...
      <div class="wrapper">
        ...
        <span class="m-icon"><i class="fa-solid fa-temperature-three-quarters"></i></span>
...
`;
  ...
  <img src="/Weather App/icons/direction.png" width="48" height="48" loading="lazy" alt="direction" class="weather-icon" style ="transform: rotate(${
    windDirection - 180
  }deg)">
